...
\subsection{Result}
\includegraphics{test_pop.png}


\includegraphics{test_push.png}


\includegraphics{test_pop_push.png}


\includegraphics{test_repeated_push_pop.png}


\includegraphics{test_pop_without_list.png}


\includegraphics{test_push_without_list.png}


\includegraphics{test_pop_push_without_list.png}


\includegraphics{test_repeated_push_pop_without_list.png}
